...
const Cart = () => {
  ...
  const showCheckout = useAppSelector((s) => s.product.isCheckoutActive)
  ...
  return (
    ...
    >
      <Checkout open={showCheckout} onClose={() => dispatch(setCheckoutState(false))} />
      <PageHeader
        sx={{
          // backgroundColor: '#f5f5f5',
      ...
      {cart.length !== 0 && (
        ...
        >
          ...
          <Button
            ...
            onClick={() => dispatch(setCheckoutState(true))}
            endIcon={
              <CustomIcon
                size={20}
                name={'LUCIDE_ICONS'}
