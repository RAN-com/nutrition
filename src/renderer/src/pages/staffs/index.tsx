...
//                 uid: user?.createdBy as string,
//                 vid: user?.sid as string
//               })
//             )

//             navigate(`/staffs/${user?.sid}`)
//           }}
//         >
//           <CustomIcon
...
//           disableTouchRipple={true}
//           onClick={async () => {
//             await deleteStaff(user?.createdBy as string, user?.sid)
//             dispatch(
//               asyncGetStaffs({
//                 uid: user?.createdBy as string
//               })
                ...
                {search.length >= 1 ? (
                  ...
                  <>
                    <CustomTypography maxWidth={'340px'} textAlign={'center'}>
                      Check your internet connection. If everything alright, refresh the
                    </CustomTypography>
                  </>
                )}
              </div>
