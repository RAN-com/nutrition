...
import { setShowAvailableModal, setUpdateDownloaded } from '@renderer/redux/features/ui/slice'
          ...
          isDownloaded ? (
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', py: 2 }}>
              ...
              <Typography variant="body1" align="center" color="text.secondary">
                You have downloaded the latest update. Please install it now to enjoy the newest
          ...
          !!downloadProgress ? (
            ...
            >
              ...
              <Box sx={{ width: '100%', textAlign: 'center' }}>
                ...
                <UpdateButton variant="outlined" onClick={handleClose} fullWidth>
              ...
              <Tooltip
                title={
                  <CustomTypography variant="caption" textAlign={'center'}>
                    You can download the latest version by clicking on the update button in your
                    profile
                  </CustomTypography>
                }
              >
